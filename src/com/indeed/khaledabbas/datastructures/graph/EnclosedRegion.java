...
public class EnclosedRegion {
	...
	public void flipWhitesInside() {
		...
		int row, col;
		com.indeed.khaledabbas.datastructures.queue.adt.Queue<Vertex> queue = new com.indeed.khaledabbas.datastructures.queue.adt.Queue<Vertex>();
	...
	private void checkReachability(int row, int col, com.indeed.khaledabbas.datastructures.queue.adt.Queue<Vertex> queue) {
